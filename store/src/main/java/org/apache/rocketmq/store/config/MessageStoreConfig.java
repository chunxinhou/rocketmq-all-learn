...
public class MessageStoreConfig {
    ...
    // The maximum size of a single log file,default is 512K = 524288 byte = 524288*8 bit = 4194304 bit
    private int maxMessageSize = 1024 * 1024 * 4;// = 4194304   //应该替换成 524288 byte
